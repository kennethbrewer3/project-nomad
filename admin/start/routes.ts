...
router
  .group(() => {
    ...
    router.get('/zones', [MapsController, 'listZones'])
    router.post('/zones', [MapsController, 'createZone'])
    router.patch('/zones/:id', [MapsController, 'updateZone'])
    router.delete('/zones/:id', [MapsController, 'deleteZone'])
